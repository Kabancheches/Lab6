...
import src.Server.Model.Classes.*;
import src.Server.Model.Enums.*;
import src.Server.Model.Validator.Validator;
...
public class FileManager  {
    ...
    public Product parseProduct(String[] line, String[] fields) {
        ...
        product.setUnitOfMeasure(parseEnum(Common.Model.UnitOfMeasure.class, line[partNumber++], fields[partNumber - 1]));
    ...
    /**
     * Простой парсер CSV строки без внешних зависимостей.
     */
    ...
    public PriorityQueue<Product> readCollection() {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(PATH), StandardCharsets.UTF_8))) {
            ...
            String[] headerFields = head.split(",");
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (!wasHead) {
                    if (fields.length == fieldsNumber && line.equals(head)) {
                        wasHead = true;
                        continue;
                    } else {
                ...
                try {
                    Product product = parseProduct(fields, headerFields);
                    if (product != null) {
